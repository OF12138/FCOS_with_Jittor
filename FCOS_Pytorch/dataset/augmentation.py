...
"""
This file contains the augmentation functions for the dataset.
It includes color jitter, random rotation, and random crop resize.
"""
...
#rotates the image by a random degree.
...
#randomly crops a region from the image and resizes it to a fixed size.
#said that the fuction doesn't really work well
