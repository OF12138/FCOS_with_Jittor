...
class GenTargets(nn.Module):
    ...
    def forward(self, inputs):
        ...
        # --- Internal calculations using Pure PyTorch Logic ---
    ...
    # This is the corrected _gen_level_targets method.
# It uses direct indexing and a clear positive mask, which is more robust.
    def _gen_level_targets(self, out, gt_boxes, classes, stride, limit_range, sample_radiu_ratio=1.5):
        ...
        if mask_pos_2.sum() > 0:
            ...
            # The corrected centerness calculation block
            # Clamp values to be non-negative before calculation
...
# In loss.py, replace the entire giou_loss function with this one.
...
# In loss.py, replace the entire compute_reg_loss function
